...
def test_jobseeker_jobs():
    ...
    jobsDataFrame = pd.DataFrame(
        [
            [1, "Python Developer", "Python, SQL, Flask, Django"],
            [2, "Frontend Developer", "Angular, React.js, HTML"],
        ],
    ...
    finalDataFrame = pd.DataFrame(
        [
            [1, "Alice", 1, "Python Developer", 3, 75.0],
            [1, "Alice", 2, "Frontend Developer", 0, 0.0],
            [2, "Peter", 2, "Frontend Developer", 3, 100.0],
            [2, "Peter", 1, "Python Developer", 1, 25.0],
        ],
        columns=[
            "Jobseeker_ID",
            "Jobseeker_Name",
    ...
    outputDataFrame = jobRecommendationEngine.calculatePercentage(
        jobsDataFrame, jobseekerDataFrame
    )
